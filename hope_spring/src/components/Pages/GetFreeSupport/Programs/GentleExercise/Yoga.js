...
// same normalizer as admin / meditation
const normalize = (v) =>
...
const benefits = [
  {
    ...
    body:
      "Helps manage distractions and increase productivity in personal and professional pursuits.",
    icon: (
      <svg
        width="22"
        height="22"
  ...
  },
  {
    ...
    body:
      "Supports a deeper sense of interconnectedness with community through understanding and support.",
    icon: (
      <svg
        width="22"
        height="22"
        ...
        fill="currentColor"
      >
        <path d="M12 21s-7-4.35-7-10a5 5 0 0110 0 5 5 0 0110 0c0 5.65-7 10-7 10s-3-1.87-6-4.9c-3 3.03-6 4.9-6 4.9z" />
      </svg>
    ),
  },
  {
    ...
    body:
      "Helps manage anxiety, depression, and other emotional challenges, improving resilience.",
    icon: (
      <svg
        width="22"
        height="22"
...
const related = [
  {
    title: "Tai Chi",
    copy:
      "A mind-body practice with flowing movements combining breath and balance.",
    img:
  ...
  },
  {
    title: "Meditation",
    copy:
      "Mindfulness exercises with encouragement to practice at home as a daily routine.",
  ...
  },
  {
    title: "Qi Gong",
    copy:
      "Gentle movements and breathing techniques to cultivate and balance energy (Qi).",
    img:
...
// Cal booking modal (same pattern as support groups / meditation)
...
export default function YogaProgramPage() {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        console.error("Error loading yoga programs:", err);
        setProgramsError("Unable to load yoga programs right now.");
      } finally {
        setLoading(false);
      }
    };
  ...
  // filter yoga programs: category gentle_exercise + subcategory yoga
  const yogaPrograms = programs.filter((p) => {
    const cat = normalize(p.category);
    const sub = normalize(p.subcategory);
    return cat === "gentle_exercise" && sub === "yoga";
  });
    ...
    <main className="min-h-screen bg-gray-50 text-gray-900">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-24 sm:py-28 lg:py-36">
          <div className="max-w-2xl text-white">
            ...
            <p className="mt-3 max-w-xl text-white/90">
              Yoga helps exercise control over physical and emotional well-being
              by combining movement, breathing, stretching, body poses and
              meditation.
            </p>
      ...
      <section className="mx-auto max-w-6xl gap-10 px-4 py-12 sm:grid sm:grid-cols-2">
        ...
        <p className="mt-4 text-gray-600 sm:mt-0">
          In this group program, yoga plays a significant role in cancer support
          by offering physical movement and mental flexibility to both patients,
          survivors, and caregivers. It helps reduce stress, anxiety, and
          fatigue commonly associated with cancer and its treatment.
        </p>
      </section>
      ...
      >
        ...
        <div className="mt-6 grid gap-8 md:grid-cols-2">
          <div className="md:col-span-2">
            ...
            ) : yogaPrograms.length === 0 ? (
              <p className="text-sm text-gray-500">
                No yoga programs are available right now. Please check the
                calendar for other offerings.
              </p>
            ) : (
              <Accordion
                items={yogaPrograms.map((p) => {
                  const linked = !!(
                    p.cal_user &&
                    p.cal_slug &&
                    p.cal_event_type_id
      ...
      <section className="mx-auto max-w-6xl grid items-start gap-8 px-4 py-10 md:grid-cols-2">
        <div className="rounded-2xl bg-gray-100 p-0 overflow-hidden">
          <img
          ...
          <Accordion
            items={[
              ...
              },
              {
                ...
                content:
                  "A yoga mat (optional), water, and comfortable clothing.",
              },
              {
                title: "Are classes online?",
                content:
                  "Many sessions are available via Zoom with closed captions.",
              },
            ]}
          />
        </div>
